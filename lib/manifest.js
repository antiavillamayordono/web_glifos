...
(function () {
  ...
  window.__CONFIG__ = {
    ...
    --------------------------------------------------------- */
    activeContest: { year: 2026, season: "verano", category: "personajes", week: 1, glyphNo: 4 },
    ...
    /* ---------------------------------------------------------
       ...
       Cuando no haya glifo del día, déjalo en null:
           dailyGlyph: null,
    --------------------------------------------------------- */
    dailyGlyph: { date: "2026-07-22", image: "assets/img/glifos/2026-personajes-04.webp", number: 4 },
