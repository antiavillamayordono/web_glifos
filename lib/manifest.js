...
(function () {
  ...
  window.__CONFIG__ = {
    ...
    --------------------------------------------------------- */
    activeContest: { year: 2026, season: "verano", category: "personajes", week: 1, glyphNo: 12 },
    ...
    /* ---------------------------------------------------------
       ...
       Cuando no haya glifo del día, déjalo en null:
           dailyGlyph: null,
    --------------------------------------------------------- */
    dailyGlyph: { date: "2026-08-03", image: "assets/img/glifos/2026-personajes-12.webp", number: 12 },
